...
-- Pane/Window management keymaps
...
vim.keymap.set('n', '<leader>wo', '<cmd>only<CR>', { desc = '[W]indow close [O]thers' })
vim.keymap.set('n', '<leader>w=', '<C-w>=', { desc = '[W]indow [=]equalize sizes' })
vim.keymap.set('n', '<leader>wh', '<C-w>H', { desc = '[W]indow move [H] left' })
vim.keymap.set('n', '<leader>wj', '<C-w>J', { desc = '[W]indow move [J] down' })
vim.keymap.set('n', '<leader>wk', '<C-w>K', { desc = '[W]indow move [K] up' })
vim.keymap.set('n', '<leader>wl', '<C-w>L', { desc = '[W]indow move [L] right' })
...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      -- Tmux session picker
      vim.keymap.set('n', '<leader>S', function()
        require('custom.telescope-tmux').pick_session(require('telescope.themes').get_dropdown {
          winblend = 10,
          previewer = false,
        })
      end, { desc = 'Tmux [S]essions' })
    end,
  },
    ...
    opts = {
      ...
      sources = {
        ...
        providers = {
          ...
          minuet = { name = 'minuet', module = 'minuet.blink', async = true, score_offset = 50 },
        },
      },
  ...
  { -- Highlight, edit, and navigate code
    ...
    opts = {
      ensure_installed = { 'bash', 'c', 'dart', 'diff', 'html', 'lua', 'luadoc', 'markdown', 'markdown_inline', 'python', 'query', 'vim', 'vimdoc' },
